...
namespace Patterns.Adapters
{
    ...
    public class LineToPointAdapter : IEnumerable<Point>
    {
        ...
        private readonly static Dictionary<int, List<Point>> cache = new Dictionary<int, List<Point>>();
    ...
    public class Example
    {
        ...
        public static void DrawPoint() => Console.Write(".");
        ...
        {
            foreach (var line in vectorObjects.SelectMany(obj => obj.Select(line => line)))
            {
                var adapter = new LineToPointAdapter(line);
                adapter.ForEach(point => DrawPoint());
                Console.WriteLine();
            }
        }
    }
